...
1. In Visual Studio, right-click on the AIRouter.ChatApp.AppHost project in the Solution Explorer and select "Manage User Secrets".
...
3. Once installed, Open the `Program.cs` file in the AIRouter.ChatApp.AppHost project.
